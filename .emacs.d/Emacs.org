...
** About this config
My config is in large parts based on this YT video tutorial ["Emacs
from scratch" by David Wilson](https://www.youtube.com/watch?v=74zOY-vgkyw&list=PLEoMzSkcN8oPH1au7H6B7bBJ4ZO7BXjSZ).
...
** Nicer editing stuff (rainbow, tabs, comments)
#+begin_src emacs-lisp
...
** Development stuff (projectile, magit)
#+begin_src emacs-lisp
...
** Documentation stuff (Org, Markdown, PlantUML)
#+begin_src emacs-lisp
;; PlantUM
